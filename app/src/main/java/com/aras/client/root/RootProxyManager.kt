...
import com.aras.client.root.RootProxyManager.TABLE
import com.aras.client.root.RootProxyManager.TUN
import com.aras.client.root.RootProxyManager.teardown
...
object RootProxyManager {
     ...
     * Mirrors Magic_Xray's hotspot rules (FORWARD accept, DNS DNAT, source-based policy
    ...
    private fun buildLanShareSetup(captureDeviceTraffic: Boolean, ipv6: Boolean): String {
        ...
        return buildString {
            ...
            // the proxy = IPv6 leak. Handle it explicitly (mirrors vincentng295/Magic_Xray
