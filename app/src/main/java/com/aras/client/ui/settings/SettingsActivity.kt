package com.aras.client.ui.settings
...
import com.aras.client.handler.MmkvManager.rememberMmkvString
import com.aras.client.handler.SettingsChangeManager
import com.aras.client.root.RootManager
...
fun SettingsScreen(
    ...
    if (showResetConfirm) {
        androidx.compose.material3.AlertDialog(
            ...
            title = { androidx.compose.material3.Text(stringResource(R.string.title_reset_settings)) },
            text = { androidx.compose.material3.Text(stringResource(R.string.summary_reset_settings)) },
            confirmButton = {
                androidx.compose.material3.TextButton(onClick = {
                    showResetConfirm = false
                    com.aras.client.handler.MmkvManager.resetSettingsToDefault()
                    context.let { c ->
                        android.widget.Toast.makeText(
                            c, c.getString(R.string.toast_success), android.widget.Toast.LENGTH_SHORT
                        ).show()
