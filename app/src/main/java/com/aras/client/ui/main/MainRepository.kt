...
import com.aras.client.dto.entities.ServerAffiliationInfo
...
class MainRepository(
    ...
    override fun bestTestedServerGuid(): String? =
        AngConfigManager.bestTestedServerGuid()

    override fun getGroupServerGuids(groupId: String): List<String> =
        MmkvManager.decodeServerList(groupId)

    override fun getShareTextForGuids(guids: List<String>): String =
        AngConfigManager.getShareTextForGuids(guids)
