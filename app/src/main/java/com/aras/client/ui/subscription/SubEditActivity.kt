...
fun SubEditScreen(
    ...
    var announcement by rememberSaveable { mutableStateOf(initial.announcement.orEmpty()) }
    var creatorMessage by rememberSaveable { mutableStateOf(initial.creatorMessage.orEmpty()) }
    ...
    fun buildSubItem(): SubscriptionItem {
        ...
        subItem.announcement = announcement.ifBlank { null }
        subItem.creatorMessage = creatorMessage.ifBlank { null }
    ...
    Scaffold(
        ...
        Column(
            ...
            FormTextField(stringResource(R.string.sub_setting_announcement), announcement, { announcement = it })
            FormTextField(stringResource(R.string.sub_setting_creator_message), creatorMessage, { creatorMessage = it })
            SettingsSwitchItem(
