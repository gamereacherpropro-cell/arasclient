...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/ArasTey"
    const val APP_API_URL = "https://api.github.com/repos/ArasTey/ArasClient/releases"
    const val APP_ISSUES_URL = "$APP_URL/ArasClient/issues"
    ...
    const val TG_CHANNEL_URL = "https://t.me/imArasTey"
    ...
    val GEO_FILES_SOURCES = arrayListOf(
        "Chocolate4U/Iran-xray-rules",
        "Loyalsoldier/xray-rules-dat",
        "runetfreedom/russia-xray-rules-dat"
    )
