...
data class ArasShareItem(
    ...
    val ProtoExtraObj: ArasProtocolExtraShareItem?,
    val TransportExtraObj: ArasTransportExtraShareItem?,
) {
    data class ArasProtocolExtraShareItem(
        val AlterId: Int?,
        ...
        val AwgCookiePacketJunkHeader: String?,
    ...
    data class ArasTransportExtraShareItem(
    ...
    fun toProfileItem(): ProfileItem {
        ...
        val profile = ProfileItem(
            ...
            cookiePacketJunkHeader = ProtoExtraObj?.AwgCookiePacketJunkHeader,
