...
import com.aras.client.dto.CertSha256Request
import com.aras.client.dto.CertSha256Result
...
object CertificateFingerprintManager {
    ...
    private fun fetch(
        ...
        return try {
            ...
            LogUtil.e(AppConfig.TAG, "Fetch $type cert SHA-256 API unavailable", e)
            null
        } catch (e: Exception) {
