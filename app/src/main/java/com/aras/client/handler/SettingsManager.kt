...
import com.aras.client.AppConfig.GEOIP_PRIVATE
import com.aras.client.AppConfig.GEOSITE_PRIVATE
import com.aras.client.AppConfig.TAG_DIRECT
import com.aras.client.AppConfig.VPN
...
import com.aras.client.enums.RoutingType
import com.aras.client.enums.VpnInterfaceAddressConfig
import com.aras.client.extension.moveItem
import com.aras.client.handler.MmkvManager.decodeAllServerList
import com.aras.client.handler.MmkvManager.decodeServerConfig
import com.aras.client.handler.MmkvManager.decodeSubsList
import com.aras.client.handler.MmkvManager.decodeSubscription
import com.aras.client.handler.MmkvManager.encodeSubscription
import com.aras.client.handler.MmkvManager.removeSubscription
...
object SettingsManager {
    ...
    fun routingRulesetsBypassLan(): Boolean {
        ...
        if (config.configType == EConfigType.CUSTOM) {
            ...
            val xrayConfig = JsonUtil.fromJsonSafe(raw, XrayConfig::class.java)
            val exist = xrayConfig?.routing?.rules?.filter { it.outboundTag == TAG_DIRECT }?.any {
