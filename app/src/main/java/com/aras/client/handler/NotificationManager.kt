...
import com.aras.client.extension.toSpeedString
...
object NotificationManager {
    ...
    private const val NOTIFICATION_PENDING_INTENT_STOP_XRAY = 1
    private const val NOTIFICATION_PENDING_INTENT_RESTART_XRAY = 2
    ...
    fun showNotification(currentConfig: ProfileItem?) {
        ...
        val stopXrayIntent = Intent(AppConfig.BROADCAST_ACTION_SERVICE)
        stopXrayIntent.`package` = AppConfig.ANG_PACKAGE
        stopXrayIntent.putExtra("key", AppConfig.MSG_STATE_STOP)
        val stopXrayPendingIntent = PendingIntent.getBroadcast(service, NOTIFICATION_PENDING_INTENT_STOP_XRAY, stopXrayIntent, flags)

        val restartXrayIntent = Intent(AppConfig.BROADCAST_ACTION_SERVICE)
        restartXrayIntent.`package` = AppConfig.ANG_PACKAGE
        restartXrayIntent.putExtra("key", AppConfig.MSG_STATE_RESTART)
        val restartXrayPendingIntent = PendingIntent.getBroadcast(service, NOTIFICATION_PENDING_INTENT_RESTART_XRAY, restartXrayIntent, flags)
        ...
        mBuilder = NotificationCompat.Builder(service, channelId)
            ...
            .addAction(
                ...
                service.getString(R.string.notification_action_stop_xray),
                stopXrayPendingIntent
            )
            .addAction(
                R.drawable.ic_restore_24dp,
                service.getString(R.string.title_service_restart),
                restartXrayPendingIntent
            )
