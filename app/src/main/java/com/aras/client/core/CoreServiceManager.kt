...
import com.aras.client.dto.OutboundTrafficStat
import com.aras.client.dto.entities.ProfileItem
import com.aras.client.enums.BrowserDialerMode
...
object CoreServiceManager {
    ...
    /**
     * Checks if the Xray service is running.
...
//        LogUtil.d(AppConfig.TAG, "Queried outbound traffic stats: $result")
    ...
    /**
     * Measures the connection delay for the current Xray configuration.
     * Tests with primary URL first, then falls back to alternative URL if needed.
     * Also fetches remote IP information if the delay test was successful.
     */
    private fun measureXrayDelay() {
        if (!isRunning()) {
            return
        }
    ...
    /**
     * Core callback handler implementation for handling Xray core events.
     * Handles startup, shutdown, socket protection, and status emission.
     */
    private class CoreCallback : CoreCallbackHandler {
        /**
         * Called when Xray core starts up.
        ...
        /**
         * Called when Xray core emits status information.
         * @param l Status code.
