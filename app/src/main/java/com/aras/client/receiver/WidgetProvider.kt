package com.aras.client.receiver
...
class WidgetProvider : AppWidgetProvider() {
     ...
     * It updates the widget background based on the Xray service running state.
     *
    ...
    /**
     * Updates the widget background based on whether the Xray service is running.
     *
     * @param context The Context in which the receiver is running.
     * @param appWidgetManager The AppWidgetManager instance.
     * @param appWidgetIds The appWidgetIds for which an update is needed.
     * @param isRunning Boolean indicating if the Xray service is running.
     */
     ...
     * It handles widget click actions and updates the widget background based on the Xray service state.
     *
     * @param context The Context in which the receiver is running.
